...
$l['all']['copyright1'] = "RADIUS Meneger, Reportarea, Contabilitate si Facturare de <a href=\"https://github.com/lirantal/daloradius\">Liran Tal</a>";
...
$l['Tooltip']['proxyRetryDelayTooltip'] = "De timp (�n secunde) pentru a a?tepta <br/>
					...
					�nainte de re-trimiterea proxied
request.";
...
$l[ 'butonul'] [ 'ListRates'] = "Lista Preturi 
";
$l[ 'butonul'] [ 'NewRate'] = "Tarif nou ";
$l[ 'butonul'] [ 'EditRate'] = "Editare Rate ";
$l[ 'butonul'] [ 'RemoveRate'] = "Elimina?i Rate ";

$l[ 'butonul'] [ 'ListPlans'] = "Lista Planuri ";
$l[ 'butonul'] [ 'NewPlan'] = "Nou plan ";
$l[ 'butonul'] [ 'EditPlan'] = "Editare Planul ";
$l[ 'butonul'] [ 'RemovePlan'] = "Elimina?i Planul ";

$l[ 'butonul'] [ 'ListRealms'] = "Lista domenii ";
$l[ 'butonul'] [ 'NewRealm'] = "Noul Realm"; 
$l[ 'butonul'] [ 'EditRealm'] = "editare Realm"; 
$l[ 'butonul'] [ 'RemoveRealm'] = "Sterge Realm"; 

$l[ 'butonul'] [ 'ListProxys'] = "Lista Proxys"; 
$l[ 'butonul'] [ 'NewProxy'] = "New Proxy"; 
$l[ 'butonul'] [ 'EditProxy'] = "editare Proxy"; 
$l[ 'butonul'] [ 'RemoveProxy'] = "Sterge Proxy"; 

$l[ 'butonul'] [ 'ListAttributesforVendor'] = "Lista de atribute pentru Vendor:"; 
$l[ 'butonul'] [ 'NewVendorAttribute'] = "Nou distribuitorul de atribut"; 
$l[ 'butonul'] [ 'EditVendorAttribute'] = "Editare furnizor de atribut ";
$l[ 'butonul'] [ 'SearchVendorAttribute'] = "Cautati atribut ";
$l[ 'butonul'] [ 'RemoveVendorAttribute'] = "Elimina?i furnizor de atribut ";
$l[ 'butonul'] [ 'ImportVendorDictionary'] = "Import Vendor Dictionar ";


$l[ 'butonul'] [ 'BetweenDates'] = "intre Datele :"; 
$l[ 'butonul'] [ 'Unde'] = "Unde "; 
...
$l[ 'butonul'] [ 'HotspotsComparison'] = "Compara?ie hotspots "; 
...
$l[ 'butonul'] [ 'ListIPPools'] = "Lista de IP-Bazine"; 
$l[ 'butonul'] [ 'NewIPPool'] = "Nou IP-Pool"; 
$l[ 'butonul'] [ 'EditIPPool'] = "Editare IP-Pool"; 
$l[ 'butonul'] [ 'RemoveIPPool'] = "?terge IP-Pool"; 
...
$l[ 'butonul'] [ 'DuplicateProfile'] = "Duplicat Profil"; 
...
$l[ 'butonul'] [ 'ManageBackups'] = "Gestionare backup"; 
$l[ 'butonul'] [ 'CreateBackups'] = "Crea?i copii de rezerv?"; 
...
$l[ 'titlu'] [ 'PlanInfo'] = "Planul de informare"; 
$l[ 'titlu'] [ 'TimeSettings'] = "Ora Set?ri"; 
$l[ 'titlu'] [ 'BandwidthSettings'] = "Bandwidth Settings"; 
$l[ 'titlu'] [ 'PlanRemoval'] = "Planul de eliminare"; 

$l[ 'titlu'] [ 'backups'] = "backup"; 
$l[ 'titlu'] [ 'FreeRADIUSTables'] = "FreeRADIUS Tabele"; 
$l[ 'titlu'] [ 'daloRADIUSTables'] = "daloRADIUS Tabele"; 

$l[ 'titlu'] [ 'IPPoolInfo'] = "IP-Pool Info"; 

$l[ 'titlu'] [ 'BusinessInfo'] = "Business Info"; 

$l[ 'titlu'] [ 'CleanupRecords'] = "Cur??ire Records"; 
$l[ 'titlu'] [ 'DeleteRecords'] = "Delete Records"; 

$l[ 'titlu'] [ 'RealmInfo'] = "Realm Info"; 

$l[ 'titlu'] [ 'ProxyInfo'] = "proxy Info"; 

$l[ 'titlu'] [ 'VendorAttribute'] = "Vendor atribut"; 

$l[ 'titlu'] [ 'AccountRemoval'] = "Contul de eliminare"; 
$l[ 'titlu'] [ 'AccountInfo'] = "Informa?ii despre cont"; 

$l[ 'titlu'] [ 'Profile'] = "Profiluri"; 
$l[ 'titlu'] [ 'ProfileInfo'] = "Profil Info"; 

$l[ 'titlu'] [ 'GroupInfo'] = "informa?ii despre grup"; 
$l[ 'titlu'] [ 'GroupAttributes'] = "Grupul Atribute"; 

$l[ 'titlu'] [ 'NASInfo'] = "SNC Info"; 
$l[ 'titlu'] [ 'NASAdvanced'] = "SNC avansat?"; 

$l[ 'titlu'] [ 'UserInfo'] = "User Info"; 
$l[ 'titlu'] [ 'BillingInfo'] = "Facturare Info"; 

$l[ 'titlu'] [ 'Atribute'] = "Atribute"; 
$l[ 'titlu'] [ 'ProfileAttributes'] = "Profil Atribute"; 

$l[ 'titlu'] [ 'HotspotInfo'] = "Hotspot Info"; 
$l[ 'titlu'] [ 'HotspotRemoval'] = "Hotspot Eliminarea"; 

$l[ 'titlu'] [ 'ContactInfo'] = "Contact"; 

$l[ 'titlu'] [ 'Planul'] = "Planul"; 

$l[ 'titlu'] [ 'Profil'] = "Profil"; 
$l[ 'titlu'] [ 'Groups'] = "Grupuri"; 
$l[ 'titlu'] [ 'RADIUSCheck'] = "Check Atribute"; 
$l[ 'titlu'] [ 'RADIUSReply'] = "R?spunde?i Atribute"; 

$l[ 'titlu'] [ 'Set?ri'] = "Set?ri"; 
$l[ 'titlu'] [ 'DatabaseSettings'] = "Baza de date Set?ri"; 
$l[ 'titlu'] [ 'DatabaseTables'] = "Baza de date Tabele"; 
$l[ 'titlu'] [ 'AdvancedSettings'] = "Set?ri avansate"; 

$l[ 'titlu'] [ 'Advanced'] = "Avansat"; 
$l[ 'titlu'] [ 'Optional'] = "Optional"; 
...
/* ************************************************ ********************************** 
* Contact 
* Servicii de la toate informa?iile de contact de tip text, utilizatorul info, hotspot proprietar informatii de contact, etc 
************************************************** **********************************/ 
