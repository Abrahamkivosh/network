...
$configRead = dirname(__FILE__).'/config_read.php';
$tableConventions = dirname(__FILE__).'/tableConventions.php';

include ($configRead);

	// include table conventions
include_once ($tableConventions);
