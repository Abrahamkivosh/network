...
$l[ 'toate'] [ 'RemoveRadacctRecords'] = "?terge �nregistr?rile contabile"; 

$l[ 'all'] [ 'CleanupSessions'] = "Cur??ire sesiuni mai vechi dec�t"; 
$l[ 'all'] [ 'DeleteSessions'] = "Delete sesiuni mai vechi dec�t"; 

$l[ 'all'] [ 'StartingDate'] = "Data"; 
...
$l[ 'all'] [ 'AcctHost'] = "ACCT-gazd?"; 
$l[ 'all'] [ 'Ldflag'] = "ldflag"; 
$l[ 'all'] [ 'Nostrip'] = "nostrip"; 
$l[ 'all'] [ 'Notrealm'] = "notrealm"; 
$l[ 'all'] [ 'Sugestii'] = "Sugestii"; 

$l[ 'all'] [ 'proxy'] = "proxy"; 
$l[ 'all'] [ 'ProxyName'] = "Proxy Name"; 
$l[ 'all'] [ 'ProxySecret'] = "proxy Secert"; 
$l[ 'all'] [ 'DeadTime'] = "Ora Dead"; 
$l[ 'all'] [ 'RetryDelay'] = "Re�ncerca?i �nt�rziere"; 
$l[ 'all'] [ 'RetryCount'] = "Re�ncerca?i Count"; 
$l[ 'all'] [ 'DefaultFallback'] = "Default fallback"; 

$l[ 'all'] [ 'NasID'] = "SNC ID"; 
$l[ 'all'] [ 'Nas'] = "NAS"; 
$l[ 'all'] [ 'NasIPHost'] = "SNC IP / gazd?"; 
$l[ 'all'] [ 'NasShortname'] = "SNC Shortname"; 
$l[ 'all'] [ 'NasType'] = "Tip NAS"; 
$l[ 'all'] [ 'NasPorts'] = "SNC Ports"; 
$l[ 'all'] [ 'NasSecret'] = "SNC secret"; 
$l[ 'all'] [ 'NasCommunity'] = "SNC comunitar"; 
$l[ 'all'] [ 'NasDescription'] = "Descriere SNC"; 
$l[ 'all'] [ 'PacketType'] = "pachete de tip"; 
$l[ 'all'] [ 'Hotspot'] =" Hotspot "; 
$l[ 'all'] [ 'hotspots'] = "hotspots"; 
$l[ 'all'] [ 'HotSpotName'] = "Hotspot Nume"; 
$l[ 'all'] [ 'username'] = "Nume de utilizator"; 
$l[ 'all'] [ 'Password'] = "password"; 
$l[ 'all'] [ 'PasswordType'] = "Parola de tip"; 
...
$l[ 'all'] [ 'CurrentGroupname'] = "Current Groupname"; 
$l[ 'all'] [ 'NewGroupname'] = "New Groupname"; 
$l[ 'all'] [ 'prioritate'] = "Prioritate"; 
$l[ 'all'] [ 'atribut'] = "atribut"; 
$l[ 'all'] [ 'Operator'] = "operator"; 
$l[ 'all'] [ 'value'] = "valoare"; 
$l[ 'all'] [ 'NewValue'] = "Noua valoare"; 
$l[ 'all'] [ 'MaxTimeExpiration'] = "Max Ora / expir?rii"; 
$l[ 'all'] [ 'UsedTime'] = "Ora folosita"; 
$l[ 'all'] [ 'Status'] = "Status"; 
$l[ 'all'] [ 'Usage'] = "Utilizare"; 
$l[ 'all'] [ 'StartTime'] = "Ora de incepere"; 
$l[ 'all'] [ 'StopTime'] = "Stop Timpul"; 
$l[ 'all'] [ 'TotalTime'] = "Total Timpul"; 
$l[ 'all'] [ 'Bytes'] = "Bytes"; 
$l[ 'all'] [ 'upload'] = "Incarca"; 
$l[ 'all'] [ 'Download'] = "Download"; 
$l[ 'all'] [ 'Terminare'] = "Terminare"; 
$l[ 'all'] [ 'NASIPAddress'] = "SNC Adresa IP"; 
$l[ 'all'] [ 'action'] = "Actiune"; 
$l[ 'all'] [ 'UniqueUsers'] = "utilizatori unici"; 
$l[ 'all'] [ 'TotalHits'] = "Total Hits"; 
$l[ 'all'] [ 'AverageTime'] = "Timpul mediu"; 
$l[ 'all'] [ 'Inregistreaza'] = "Inregistrari"; 
$l[ 'all'] [ 'Sumar'] = "Rezumat"; 
$l[ 'all'] [ 'Statistics'] = "Statistica"; 
$l[ 'all'] [ 'credit'] = "credit"; 
$l[ 'all'] [ 'Utilaje'] = "folosit"; 
$l[ 'all'] [ 'LeftTime'] = "Ora r?m�ne"; 
$l[ 'all'] [ 'LeftPercent'] = "% din timp la st�nga"; 
$l[ 'all'] [ 'TotalSessions'] = "Total Sessions"; 
$l[ 'all'] [ 'LastLoginTime'] = "Last Login Timpul"; 
$l[ 'all'] [ 'TotalSessionTime'] = "Total Session Timpul"; 
$l[ 'all'] [ 'Rate'] = "Rata"; 
$l[ 'all'] [ 'facturat'] =" facturat "; 
$l[ 'all'] [ 'TotalUsers'] = "Total Utilizatori"; 
$l[ 'all'] [ 'TotalBilled'] = "Total facturat"; 
$l[ 'all'] [ 'CardBank'] = "Carte de Banca"; 
$l[ 'all'] [ 'type'] = "Tip"; 
$l[ 'all'] [ 'CardBank'] = "CardBank"; 
$l[ 'all'] [ 'MACAddress'] = "adresa MAC"; 
$l[ 'all'] [ 'Geocode'] = "Geocode"; 
$l[ 'all'] [ 'PINCode'] = "cod PIN"; 
$l[ 'all'] [ 'CreationDate'] = "Data de Crea?ie"; 

$l[ 'all'] [ 'edit'] = "Edit"; 
$l[ 'all'] [ 'del'] = "del"; 
$l[ 'all'] [ 'groupslist'] = "grupuri-list"; 
$l[ 'all'] [ 'TestUser'] = "Test de utilizator"; 
$l[ 'all'] [ 'Contabilitate'] = "Contabilitate"; 
$l[ 'all'] [ 'RADIUSReply'] = "RADIUS R?spunde?i"; 

$l[ 'all'] [ 'Deconectare'] = "Deconectare"; 

$l[ 'all'] [ 'Debug '] =" Debug "; 
$l[ 'all'] [ 'Timeout '] =" Timeout "; 
$l[ 'all'] [ 're�ncearc?'] = "re�ncearc?"; 
$l[ 'all'] [ 'Count '] =" Count "; 
$l[ 'all'] [ 'Cereri'] = "cereri"; 
...
$l[ 'all'] [ 'DatabaseName'] = "Numele bazei de date"; 

$l[ 'toate'] [ 'PrimaryLanguage'] = "Limba principal?"; 

$l[ 'all'] [ 'PagesLogging'] = "Logging de pagini (pagin? de vizite)"; 
$l[ 'all'] [ 'QueriesLogging'] = "Logging de Interog?ri (rapoarte ?i grafice)"; 
$l[ 'all'] [ 'ActionsLogging'] = "Logging de ac?iuni (formularul sus?ine)"; 
$l[ 'all'] [ 'FilenameLogging'] = "Jurnalizarea filename (complet calea)"; 
$l[ 'all'] [ 'LoggingDebugOnPages'] = "Jurnalizarea Debug info de pe paginile"; 
$l[ 'all'] [ 'LoggingDebugInfo'] = "Logging de Debug Info"; 

$l[ 'all'] [ 'PasswordHidden'] = "Enable Parola Ascunderea (asterisc va fi afi?at)"; 
$l[ 'all'] [ 'TablesListing'] = "Rows / �nregistr?ri pe Tabele Afi?area pagina"; 
$l[ 'all'] [ 'TablesListingNum'] = "Enable Tabele Afi?area Numerotare"; 
$l[ 'all'] [ 'AjaxAutoComplete'] = "Enable Ajax Auto-complete"; 

$l[ 'all'] [ 'RadiusServer'] = "Raza Server"; 
$l[ 'all'] [ 'RadiusPort'] = "Raza de port"; 
...
$l[ 'all' ] [ 'radgroupcheck'] = "radgroupcheck"; 
$l[ 'all'] [ 'radgroupreply'] = "radgroupreply"; 
$l[ 'all'] [ 'Utilizatori'] = "Utilizatori"; 
$l[ 'all'] [ 'radacct'] = "radacct"; 
$l[ 'all'] [ 'operatori'] = "operatori"; 
$l[ 'all'] [ 'rate'] = "tarife"; 
$l[ 'all'] [ 'hotspots'] = "hotspots"; 

$l[ 'all'] [ 'DBPasswordEncryption'] = "DB Parola de criptare de tip"; 


$l[ 'all'] [ 'CurrentPassword'] = "Parola actual?"; 
$l[ 'all'] [ 'Newpassword'] = "Noua parola"; 
$l[ 'all'] [ 'VerifyPassword'] = "Verifica parola";
...
$l[ 'Tooltip'] [ 'proxyNameTooltip'] = "Exemplu: <br/> 
. <br/> ";
$l[ 'Tooltip'] [ 'proxyRetryDelayTooltip'] = "Exemplu: <br/> 
. <br/> "; 
$l[ 'Tooltip'] [ 'proxyRetryCountTooltip'] = "Exemplu: <br/> 
. <br/> "; 
$l[ 'Tooltip'] [ 'proxyDeadTimeTooltip'] = "Exemplu: <br/> 
. <br/> "; 
$l[ 'Tooltip'] [ 'proxyDefaultFallbackTooltip'] = "Exemplu: <br/> 
. <br/> "; 



$l[ 'Tooltip'] [ 'realmNameTooltip'] = "Exemplu: <br/> 
. <br/> "; 
$l[ 'Tooltip'] [ 'realmTypeTooltip'] = "Exemplu: <br/> 
. <br/> "; 
$l[ 'Tooltip'] [ 'realmSecretTooltip'] = "Exemplu: <br/> 
. <br/> "; 
$l[ 'Tooltip'] [ 'realmAuthhostTooltip'] = "Exemplu: <br/> 
. <br/> "; 
$l[ 'Tooltip'] [ 'realmAccthostTooltip'] = "Exemplu: <br/> 
. <br/> "; 
$l[ 'Tooltip'] [ 'realmLdflagTooltip'] = "Exemplu: <br/> 
. <br/> "; 
$l[ 'Tooltip'] [ 'realmNostripTooltip'] = "Exemplu: <br/> 
. <br/> "; 
$l[ 'Tooltip'] [ 'realmHintsTooltip'] = "Exemplu: <br/> 
. <br/> "; 
$l[ 'Tooltip'] [ 'realmNotrealmTooltip'] = "Exemplu: <br/> 
. <br/> "; 


$l[ 'Tooltip'] [ 'vendorNameTooltip'] = "Exemplu: Cisco <br/> 
Numele v�nz?torului. <br/> "; 
$l[ 'Tooltip'] [ 'typeTooltip'] = "Exemplu: string <br/> 
Atributele variabila de tip <br/> 
(String, integer, data, IP). "; 
$l[ 'Tooltip'] [ 'attributeTooltip'] = "Exemplu: �nr?mat?-Ipaddress <br/> 
Exact? nume de atribut. <br/> "; 

$l[ 'Tooltip'] [ 'RecommendedOPTooltip'] = "Exemplu:: = <br/> 
Recomandat? atribut al operatorului. <br/> 
(Unul dintre:: = ==! = Etc ..)"; 
$l[ 'Tooltip'] [ 'RecommendedTableTooltip'] = "Exemplu: verifica <br/> 
Recomandat? ?int? de mas?. <br/> 
(Fie verifica?i sau r?spuns). "; 
$l[ 'Tooltip'] [ 'RecommendedTooltipTooltip'] = "Exemplu: adresa de IP pentru utilizator <br/> 
Recomandat? tooltip. <br/> "; 
$l[ 'Tooltip'] [ 'RecommendedHelperTooltip'] = "func?ia de ajutor, care va fi <br/> 
disponibile atunci c�nd a ad?uga acest atribut <br/> "; 
...
$l[ 'Tooltip'] [ 'hotspotMacaddressTooltip'] = "Exemplu: 00aabbccddee <br/> 
Adresa MAC a SNC <br/> "; 
...
$l[ 'butonul'] [ 'Changepassword '] =" Schimbare parol? "; 
$l[ 'butonul'] [ 'EditUserInfo'] = "Edita?i informa?iile de contact"; 

$l[ 'butonul'] [ 'Preferences'] = "Preferin?e"; 
$l[ 'butonul'] [ 'Contabilitate'] = "Contabilitate"; 
$l[ 'butonul'] [ 'Grafuri '] =" Grafuri "; 

$l[ 'butonul'] [ 'ClearSessions'] = "Clear Sessions"; 

$l[ 'butonul'] [ 'ListRealms'] = "Lista domenii"; 
$l[ 'butonul'] [ 'NewRealm'] = "New Realm"; 
$l[ 'butonul'] [ 'EditRealm'] = "Editare Realm"; 
$l[ 'butonul'] [ 'RemoveRealm'] = "?terge Realm"; 

$l[ 'butonul'] [ 'ListProxys'] = "Lista Proxys"; 
$l[ 'butonul'] [ 'NewProxy'] = "New Proxy"; 
$l[ 'butonul'] [ 'EditProxy'] = "Editare Proxy"; 
$l[ 'butonul'] [ 'RemoveProxy'] = "?terge Proxy"; 

$l[ 'butonul'] [ 'ListAttributesforVendor'] = "Lista de atribute pentru Vendor:"; 
$l[ 'butonul'] [ 'NewVendorAttribute'] = "New Vendor atribut"; 
$l[ 'butonul'] [ 'EditVendorAttribute'] = "Editare atribut al Vendor"; 
$l[ 'butonul'] [ 'SearchVendorAttribute'] = "Caut? atribut"; 
$l[ 'butonul'] [ 'RemoveVendorAttribute'] = "?terge furnizor de atribut"; 


$l[ 'butonul'] [ 'BetweenDates'] = "�ntre Date:"; 
$l[ 'butonul'] [ 'Unde'] = "�n cazul �n care"; 
$l[ 'butonul'] [ 'AccountingFieldsinQuery'] = "Domenii de Contabilitate �n Interogare:"; 
$l[ 'butonul'] [ 'OrderBy'] = "Prin Ordinul"; 
$l[ 'butonul'] [ 'HotspotAccounting'] = "Hotspot de contabilitate"; 
$l[ 'butonul'] [ 'HotspotsComparison'] = "hotspots Compara?ie"; 

$l[ 'butonul'] [ 'CleanupStaleSessions'] = "Cur??ire surmenat Sessions"; 
$l[ 'butonul'] [ 'DeleteAccountingRecords'] = "Delete �nregistr?ri contabile"; 

$l[ 'butonul'] [ 'Listusers '] =" Lista utilizatorilor "; 
$l[ 'butonul'] [ 'NewUser'] = "utilizator nou"; 
$l[ 'butonul'] [ 'NewUserQuick'] = "utilizator nou - Ad?ugare rapid?"; 
$l[ 'butonul'] [ 'BatchAddUsers'] = "Serie ad?uga utilizatori"; 
$l[ 'butonul'] [ 'EditUser'] = "Editare utilizator"; 
$l[ 'butonul'] [ 'SearchUsers'] = "Caut? utilizatori"; 
$l[ 'butonul'] [ 'RemoveUsers'] = "?terge Utilizatorii"; 
$l[ 'butonul'] [ 'ListHotspots'] = "Lista" hotspots "; 
$l[ 'butonul'] [ 'NewHotspot'] = "New Hotspot"; 
$l[ 'butonul'] [ 'EditHotspot'] = "Editare Hotspot"; 
$l[ 'butonul'] [ 'RemoveHotspot'] = "?terge Hotspot"; 

$l[ 'butonul'] [ 'ListNAS'] = "Lista NAS"; 
$l[ 'butonul'] [ 'NewNAS'] = "New NAS"; 
$l[ 'butonul'] [ 'EditNAS'] = "Editare NAS"; 
$l[ 'butonul'] [ 'RemoveNAS'] = "?terge NAS"; 

$l[ 'butonul'] [ 'ListUserGroup'] = "Lista de utilizatori map?rile-Group"; 
$l[ 'butonul'] [ 'ListUsersGroup'] = "Lista de utilizare al Grupului map?rile"; 
$l[ 'butonul'] [ 'NewUserGroup'] = "utilizator nou-map?rile Group"; 
$l[ 'butonul'] [ 'editusergroup '] =" Editare User-map?rile Group "; 
$l[ 'butonul'] [ 'RemoveUserGroup'] = "?terge-User Group map?rile"; 

$l[ 'butonul'] [ 'ListProfiles'] = "Lista Profile"; 
$l[ 'butonul'] [ 'NewProfile'] = "Profil nou"; 
$l[ 'butonul'] [ 'EditProfile'] = "Editare Profil"; 
$l[ 'butonul'] [ 'RemoveProfile'] = "?terge Profil"; 

$l[ 'butonul'] [ 'ListGroupReply'] = "Lista de grup R?spunde?i map?rile"; 
$l[ 'butonul'] [ 'SearchGroupReply'] = "Caut? Grupului R?spunde?i"; 
$l[ 'butonul'] [ 'NewGroupReply'] = "New Group R?spunde?i Mapare"; 
$l[ 'butonul'] [ 'EditGroupReply'] = "Edit Group R?spunde?i Mapare"; 
$l[ 'butonul'] [ 'RemoveGroupReply'] = "?terge Grupului R?spunde?i Mapare"; 

$l[ 'butonul'] [ 'ListGroupCheck'] = "Lista de grup Verifica?i map?rile"; 
$l[ 'butonul'] [ 'SearchGroupCheck'] = "Caut? Grupului Check"; 
$l[ 'butonul'] [ 'NewGroupCheck'] = "New Group Verifica?i Mapare"; 
$l[ 'butonul'] [ 'EditGroupCheck'] = "Edit Group Verifica?i Mapare"; 
$l[ 'butonul'] [ 'RemoveGroupCheck'] = "?terge Grupului Verifica?i Mapare"; 

$l[ 'butonul'] [ 'UserAccounting'] = "utilizator de contabilitate"; 
$l[ 'butonul'] [ 'IPAccounting'] = "IP Contabilitate"; 
$l[ 'butonul'] [ 'NASIPAccounting'] = "SNC IP Contabilitate"; 
$l[ 'butonul'] [ 'DateAccounting'] = "Data de contabilitate"; 
$l[ 'butonul'] [ 'AllRecords'] = "Toate Records"; 
$l[ 'butonul'] [ 'ActiveRecords'] = "active Records"; 

$l[ 'butonul'] [ 'OnlineUsers'] = "Online Users"; 
$l[ 'butonul'] [ 'LastConnectionAttempts'] = "Ultima conexiune �ncerc?rile de"; 
$l[ 'butonul'] [ 'TopUser'] = "Top utilizatorului"; 

$l[ 'butonul'] [ 'ServerStatus'] = "Server Status"; 
$l[ 'butonul'] [ 'ServicesStatus'] = "Servicii de stare"; 

$l[ 'butonul'] [ 'daloRADIUSLog'] = "daloRADIUS Jurnal"; 
$l[ 'butonul'] [ 'RadiusLog'] = "Raza Jurnal"; 
$l[ 'butonul'] [ 'SystemLog'] = "System Log"; 
$l[ 'butonul'] [ 'bootlog'] = "boot Jurnal"; 

$l[ 'butonul'] [ 'UserLogins'] = "User Conect?ri"; 
$l[ 'butonul'] [ 'UserDownloads'] = "utilizator Download-uri"; 
$l[ 'butonul'] [ 'UserUploads'] = "Utilizatorul �ncarc?"; 
$l[ 'butonul'] [ 'TotalLogins'] = "Total Conect?ri"; 
$l[ 'butonul'] [ 'TotalTraffic'] = "Total de trafic"; 

$l[ 'butonul'] [ 'ViewMAP'] = "Vizualizare hart?"; 
$l[ 'butonul'] [ 'EditMAP'] = "Editare MAP"; 
$l[ 'butonul'] [ 'RegisterGoogleMapsAPI'] = "RegisterGoogleMaps API"; 

$l[ 'butonul'] [ 'DatabaseSettings'] = "Baza de date Set?ri"; 
$l[ 'butonul'] [ 'LanguageSettings'] = "Language Settings"; 
$l[ 'butonul'] [ 'LoggingSettings'] = "Jurnalizarea Set?ri"; 
$l[ 'butonul'] [ 'InterfaceSettings'] = "Interface Settings"; 

$l[ 'butonul'] [ 'TestUserConnectivity'] = "Test de utilizator Conectivitate"; 
$l[ 'butonul'] [ 'DisconnectUser'] = "Deconectare utilizatorului"; 

$l[ 'butonul'] [ 'ListOperators'] = "Lista Operatorii"; 
$l[ 'butonul'] [ 'NewOperator'] = "nou operator"; 
$l[ 'butonul'] [ 'EditOperator'] = "Editare Operator"; 
$l[ 'butonul'] [ 'RemoveOperator'] = "?terge Operator"; 

$l[ 'butonul'] [ 'ProcessQuery '] =" Procesul de Interogare ";
...
$l[ 'ContactInfo'] [ 'Compania'] = "Compania"; 
$l[ 'ContactInfo'] [ 'Adresa'] = "Adresa"; 
$l[ 'ContactInfo'] [ 'Adresa'] = "Adresa"; 
$l[ 'ContactInfo'] [ 'City'] = "City"; 
$l[ 'ContactInfo'] [ 'membru'] = "membru"; 
...
$l[ 'Intro'] [ 'prefmain.php'] = "Pagina de Preferin?e"; 
$l[ 'Intro'] [ 'prefpasswordedit.php'] = "Schimbare parol?"; 
$l[ 'Intro'] [ 'prefuserinfoedit.php'] = "Modifica?i informa?ii de utilizator"; 
...
$l[ 'Intro'] [ 'billpersecond.php'] = "preplatite de contabilitate"; 
$l[ 'Intro'] [ 'billprepaid.php'] = "preplatite de contabilitate"; 
...
$l[ 'Helppage'] [ 'configbackupbackup'] = "Realiza?i backup"; 
...
$l[ 'mesaje'] [ 'noCheckAttributesForUser'] = "Acest utilizator nu are nici un control atribute asociate cu acesta"; 
$l[ 'mesaje'] [ 'noReplyAttributesForUser'] = "Acest utilizator nu are nici un r?spuns atribute asociate cu acesta"; 

$l[ 'mesaje'] [ 'noCheckAttributesForGroup'] = "Acest grup nu are nici un control atribute asociate cu acesta"; 
$l[ 'mesaje'] [ 'noReplyAttributesForGroup'] = "Acest grup nu are nici un r?spuns atribute asociate cu acesta"; 

$l[ 'mesaje'] [ 'nogroupdefinedforuser'] = "Acest utilizator nu are nicio grupuri asociate cu acesta"; 
$l[ 'mesaje'] [ 'wouldyouliketocreategroup'] = "Dori?i s? crea?i o?"; 


$l[ 'mesaje'] [ 'missingratetype'] = "Eroare: lipsesc rata de tip pentru a ?terge"; 
$l[ 'mesaje'] [ 'missingtype'] = "Eroare: lips? de tip"; 
$l[ 'mesaje'] [ 'missingcardbank'] = "Eroare: lipsesc cardbank"; 
$l[ 'mesaje'] [ 'missingrate'] = "Eroare: lipsesc rata"; 
$l[ 'mesaje'] [ 'succes'] = "de succes"; 
$l[ 'mesaje'] [ 'gisedit1'] = "Bine ai venit, pe care �n mod Editare"; 
...
$l[ 'mesaje'] [ 'gisedit5'] = "V? rug?m s? introduce?i numele de Hotspot"; 
$l[ 'mesaje'] [ 'gisedit6'] = "V? rug?m s? introduce?i adresa de MAC a Hotspot"; 

$l[ 'mesaje'] [ 'gismain1'] = "au fost actualizate cu succes GoogleMaps API codul de inregistrare"; 
$l[ 'mesaje'] [ 'gismain2'] = "Eroare: nu sa putut deschide fi?ierul de scris:"; 
$l[ 'mesaje'] [ 'gismain3'] = "Check fi?ier permissions. Fi?ierul ar trebui s? fie de scriere de c?tre server de utilizator / grup"; 
$l[ 'mesaje'] [ 'gisviewwelcome'] = "Bine ati venit la Enginx Visual Maps"; 
...
$l[ 'butoane'] [ 'aplica'] = "Aplica"; 

$l[ 'meniu'] [ 'Acas?'] = "H <em> </ em> ome </ a>"; 
$l[ 'meniu'] [ 'Preferences'] = "<em> P </ em> trimiteri </ a>"; 
$l[ 'meniu'] [ 'Management'] = "<em> M </ em> anagement </ a>"; 
$l[ 'meniu'] [ 'Rapoarte'] = "<em> R </ em> eports </ a>"; 
$l[ 'meniu'] [ 'Contabilitate'] = "<em> A </ em> ccounting </ a>"; 
$l[ 'meniu'] [ 'Facturare'] = "<em> B </ em> illing </ a>"; 
$l[ 'meniu'] [ 'Gis'] = "<em> G </ em> este </ a>"; 
$l[ 'meniu'] [ 'Grafuri '] =" <em> G </ em> raphs </ a> "; 
$l[ 'meniu'] [ 'config'] = "<em> C </ em> onfig </ a>"; 
$l[ 'meniu'] [ 'Help'] = "H <em> </ em> elp </ a>"; 
?>
