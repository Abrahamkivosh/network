...
<div id="contentnorightbar">
	...
	while ($row = $res->fetchRow()) {
		...
		printqn("
			<td style='text-align:right; display:flex; justify-content:space-around; color:black; font-weight: bold;' > <input type='checkbox' name='username[]' value='$row[0]' > <span> $accNo </span></td>
			<td>$row[5] $row[6]</td>
			<td> 
		");
